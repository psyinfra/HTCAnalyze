...
#         results = htcanalyze.analyze_logs(log_files)
#     else:
...
# def wrap_condorlog_to_table(condor_log) -> Table:
#     table = Table(
#         title="Job Details",
#         show_header=True,
#         header_style="bold magenta",
...
#     table.add_row("State", self.state_manager.state)
#     table.add_row("Submitter Address", self.set_events.submitter_address)
#     table.add_row("Host Address", self.set_events.host_address)
#     table.add_row("Return Value", str(self.set_events.return_value))
#
#     table.add_row("-"*10, "-"*10)
#
#     time_table = self.set_events.time_manager.wrap_to_table()
